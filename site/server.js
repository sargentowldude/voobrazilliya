...
const animatorIntroNote = () => `<section class="animator-intro-note" aria-labelledby="animator-intro-title"><div class="animator-intro-note__lead"><span class="mono-tag">Честно о нас</span><h2 id="animator-intro-title">Мы только начинаем.<em>Поэтому особенно стараемся.</em></h2></div><div class="animator-intro-note__copy"><p>«ВообразилЛиЯ» — новое праздничное агентство в Кемерово. У нас пока небольшой каталог героев, зато каждый образ уже готов к настоящему празднику — с игровой программой, реквизитом и выездом.</p><p>Мы начинаем с доступной цены и хотим заслужить вашу рекомендацию делом. Попробуйте нас в деле — и оцените по улыбке ребёнка, а не по размеру каталога.</p><ul aria-label="Что уже готово"><li>От 2500 ₽</li><li>Игры и реквизит</li><li>Выезд по Кемерово</li></ul><span class="animator-intro-note__signature">Команда «ВообразилЛиЯ»</span></div></section>`;
