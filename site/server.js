...
const showHeroChoiceDialog = () => `<dialog class="hero-choice-dialog show-hero-choice-dialog" data-show-hero-choice><button class="dialog-close" type="button" data-close-show-hero-choice aria-label="Закрыть">×</button><div class="hero-choice show-hero-choice"><span class="mono-tag">Дополнение к шоу</span><h2 data-show-choice-title>Добавим<br>аниматоров?</h2><p data-show-choice-description>К этому шоу можно добавить любимых персонажей.</p><section class="show-hero-choice__note"><strong>До двух аниматоров</strong><span>Вы сами увидите каждого в составе заказа и общую сумму до отправки заявки.</span></section><div class="hero-choice__actions"><button class="hero-choice__no" type="button" data-show-choice-no>Только<br>шоу</button><button class="hero-choice__yes" type="button" data-show-choice-yes>Выбрать<br>аниматоров</button></div></div></dialog>`;
